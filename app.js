...
app.use(function(req, res, next) {
  ...
  res.setHeader(
    "Access-Control-Allow-Headers","X-Requested-With,content-type, Authorization, Origin, Host, Accept, Origin, Referer, User-Agent"
  );
  next();
});

app.use("/api/v1", utils.ensureAuthorized, require('./app/api/v1/routes')(express));
